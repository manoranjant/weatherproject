...
const SidePanel = (props: Props) => {
  ...
  return (
    <div
      className={clsx(
        "fixed top-0 right-0 h-screen w-(--sidebar-width) shadow bg-sidebar z-1001 py-8 px-4! overflow-y-scroll transition-transform duration-300 lg:translate-x-0!",
        ...
        <Tooltip>
          ...
          <TooltipContent className="z-2000">
            <p className="max-w-xs">
              Air Quality Index. Possible values:1, 2, 3, 4, 5. bla bla bla bla
              bla
            </p>
          </TooltipContent>
        </Tooltip>
            ...
            <div className="flex justify-between capitalize">
              <div className="flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="z-2000">
                    <p className="max-w-xs">
                      Air Quality Index. Possible values:1, 2, 3, 4, 5. bla bla
                      bla bla bla
                    </p>
                  </TooltipContent>
                </Tooltip>
...
const airQualityRanges: AirQualityRanges = {
  ...
  O3: {
    Good: { min: 0, max: 60 },
    Fair: { min: 60, max: 100 },
    Moderate: { min: 140, max: 140 },
    Poor: { min: 140, max: 180 },
    "Very Poor": { min: 180, max: null },
  },
  CO: {
    Good: { min: 0, max: 4400 },
    Fair: { min: 9400, max: 9400 },
    Moderate: { min: 25, max: 5124000 },
